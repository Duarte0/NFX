...
| 27 | [ ] | [p10-application-shell.md](p10-application-shell.md) | P10 | P10-02 — shell desktop/notebook, implementação pronta no issue 0035; browser pendente | P10-01 |
| 28 | [ ] | [p10-dashboard-ux.md](p10-dashboard-ux.md) | P10 | P10-03 — dashboard | P10-01/02, P8-02 |
| 29 | [ ] | [p10-documents-ux.md](p10-documents-ux.md) | P10 | P10-04 — documentos | P10-01/02, P7 |
| 30 | [ ] | [p10-companies-certificates-collections-ux.md](p10-companies-certificates-collections-ux.md) | P10 | P10-05 — empresas, certificados e coletas | P10-01/02, P2/P3/P5/P6 |
| 31 | [ ] | [p10-exports-ux.md](p10-exports-ux.md) | P10 | P10-06 — exportações ZIP | P10-01/02, P8-01 |
| 32 | [ ] | [p10-administration-ux.md](p10-administration-ux.md) | P10 | P10-07 — administração | P10-01/02, P1/P8/P9 |
...
- **P10-02 em validação no issue 0035:** `App.tsx` publica header/sidebar/main, skip link, modelo tipado de navegação por papel, active state sincronizado por hash e o destino único autorizado `#certificados`; contrato UI, lint e build registram a implementação sem mudança HTTP ou dependência nova. A matriz Chrome/Firefox/Edge ainda falta.
