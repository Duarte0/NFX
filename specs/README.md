...
| 19 | [ ] | [p8-dashboard-and-operational-health.md](p8-dashboard-and-operational-health.md) | P8 | **P8-02 slice inicial (issue 0018) + saúde de backup Admin-only (issue 0025) + drill-down de execuções de coleta (issue 0026) + drill-down de documentos (issue 0027) + drill-down de empresas (issue 0028) + drill-down de certificados (issue 0029); P5–P7, rendering, disco e jobs permanecem indisponíveis/pendentes** | P3-04 + dados P2–P7 disponíveis; entrega progressiva permitida |
