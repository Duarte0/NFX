...
## Summary
- 1005 nodes · 1426 edges · 109 communities (63 shown, 46 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 53 edges (avg confidence: 0.58)
...
### Community 0 - "ArtifactStorageService"
Cohesion: 0.08
...
Cohesion: 0.13
Nodes (49): Action, authorize(), The single fail-closed policy used by HTTP handlers and future workers., _admin_event(), _assert_not_last_administrator(), _assert_version(), authenticate(), change_own_password() (+41 more)

### Community 2 - "Graphify Skill Instructions"
Cohesion: 0.05
...
### Community 3 - "Arquitetura técnica — NFX INOV"
Cohesion: 0.04
...
### Community 4 - "audit/services.py"
Cohesion: 0.08
Nodes (37): Any, AuditEvent, AuditChain, AuditEvent, Meta, The single stream serializes appends without allowing event rewrites., AuditService, AuditUnavailable (+29 more)
...
### Community 7 - "Consulta de documentos e download individual"
Cohesion: 0.05
...
### Community 15 - "test_identity.py"
Cohesion: 0.17
Nodes (15): bootstrap_first_administrator(), Create exactly the installation account, only while the user table is empty., Command, BaseCommand, CaptureFixture, django_db, MonkeyPatch, test_bootstrap_command_reads_external_secret_without_echoing_it() (+7 more)

### Community 16 - "9. Requisitos funcionais e regras de negócio"
Cohesion: 0.15
...
### Community 17 - "Persistência relacional e migrações"
Cohesion: 0.17
...
### Community 18 - "Fundação de auditoria append-only"
Cohesion: 0.18
...
### Community 19 - "Autenticação, sessões, RBAC e shell web"
Cohesion: 0.18
...
### Community 20 - "Ingestão fiscal comum e integridade"
Cohesion: 0.18
...
### Community 21 - "Fundação do projeto"
Cohesion: 0.20
...
### Community 22 - "Configuração segura e isolamento fiscal de testes"
Cohesion: 0.20
...
### Community 24 - "Certificados A1 e criptografia por envelope"
Cohesion: 0.20
...
### Community 25 - "Empresas, fluxos e enriquecimento público"
Cohesion: 0.20
...
### Community 26 - "Jobs duráveis, leases, políticas e observabilidade inicial"
Cohesion: 0.20
...
### Community 27 - "Exportação ZIP assíncrona"
Cohesion: 0.20
...
### Community 28 - "Technical Architecture - NFX INOV"
Cohesion: 0.22
...
### Community 30 - "Simuladores fiscais e fixtures seguras"
Cohesion: 0.22
...
### Community 31 - "Controle manual de coleta"
Cohesion: 0.22
...
### Community 32 - "Elegibilidade de retenção e prévia administrativa"
Cohesion: 0.22
...
### Community 34 - "19 Jornadas principais"
Cohesion: 0.25
...
### Community 35 - "Dashboard e saúde operacional"
Cohesion: 0.25
...
### Community 36 - "Backup e restauração comprovada"
Cohesion: 0.25
...
### Community 37 - "Exclusão definitiva controlada"
Cohesion: 0.25
...
### Community 38 - "Runtime interno e HTTPS"
Cohesion: 0.25
...
### Community 39 - "urls.py"
Cohesion: 0.43
Nodes (6): index(), live(), HttpRequest, HttpResponse, JsonResponse, ready()

### Community 40 - "BFS Traversal"
Cohesion: 0.29
...
Cohesion: 0.29
Nodes (4): AuditEvent, ManagedUser, root, User

### Community 42 - "Hardening, ameaças e testes de falha"
Cohesion: 0.29
...
### Community 43 - "Piloto interno e homologação segregada"
Cohesion: 0.29
...
Cohesion: 0.62
Nodes (6): django_db, test_clean_install_and_rerun_produce_the_same_schema(), test_failed_migration_is_not_recorded_and_a_safe_correction_can_continue(), test_schema_status_detects_ahead_incompatible_history(), test_two_migrators_are_serialized_and_only_one_applies_the_baseline(), _unapply_nfx_migrations()

### Community 45 - "graphify reference: query, path, explain"
Cohesion: 0.33
Nodes (5): For /graphify explain, For /graphify path, graphify reference: query, path, explain, Step 0 — Constrained query expansion (REQUIRED before traversal), Step 1 — Traversal

### Community 47 - "7. Usuários e papéis"
Cohesion: 0.40
Nodes (5): 7.1 Administrador, 7.2 Operador, 7.3 Visualizador, 7.4 Regra global, 7. Usuários e papéis

### Community 48 - "10. Arquitetura de componentes"
Cohesion: 0.50
...
- **Why does `P8 ZIP, dashboard e retenção` connect `P9 Operação e piloto` to `Dashboard e saúde operacional`, `Consulta de documentos e download individual`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `P1 Núcleo seguro` connect `Consulta de documentos e download individual` to `Plano de implementação — NFX INOV`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
...
- **Should `identity/services.py` be split into smaller, more focused modules?**
  _Cohesion score 0.13273001508295626 - nodes in this community are weakly interconnected._