    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "family",
                    models.CharField(choices=[("nfe", "NF-e"), ("nfse", "NFS-e")], max_length=8),
                ),
                (
                    "state",
                    models.CharField(
                        choices=[("habilitado", "Habilitado"), ("pausado", "Pausado")],
                        default="habilitado",
                        max_length=10,
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("malformado", "Conteúdo malformado"),
                        ],
                        max_length=20,
                    ),
                ),
        ...
        migrations.AddIndex(
            model_name="company",
            index=models.Index(fields=["legal_name"], name="nfx_company_name_ix"),
        ),
        migrations.AddIndex(
            model_name="company",
            index=models.Index(fields=["status"], name="nfx_company_status_ix"),
        ),
        migrations.AddIndex(
            model_name="company", index=models.Index(fields=["cnpj"], name="nfx_company_cnpj_ix")
        ),
        migrations.AddConstraint(
            model_name="company",
            constraint=models.CheckConstraint(
                condition=~Q(status="desativada")
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["family", "state"], name="nfx_company_flow_state_ix"),
        ),
        migrations.AddConstraint(
            model_name="companyflow",
            constraint=models.UniqueConstraint(
                fields=("company", "family"), name="nfx_company_flow_uq"
            ),
        ),
        migrations.AddIndex(
            model_name="enrichmentsnapshot",
            index=models.Index(
                fields=["company", "obtained_at"], name="nfx_company_enrich_time_ix"
            ),
        ),
        migrations.AddIndex(
            model_name="enrichmentsnapshot",
            index=models.Index(fields=["source", "status"], name="nfx_company_enrich_status_ix"),
        ),
    ]
