...
| 4 | **P10 Frontend UX & Visual System — in progress (P10-01..P10-07 concluídos)** | Modernizar a experiência operacional sem reescrita funcional: identidade institucional, shell desktop/notebook, componentes compartilhados e apresentação consistente dos fluxos já entregues. Specs P10-01..08 definem os contratos; cada slice só conclui com compatibilidade de contratos e validação dos estados críticos aplicáveis. | É independente de P9-05; P10-08 segue após o slice administrativo. As matrizes sintéticas de P10-02..P10-07 são reproduzíveis sem dados reais; P10-07 passou no target Docker porque o host não possui browsers/dependências. Preserva `App → features → shared`, contratos HTTP, IDs/âncoras, URLs de drill-down e autorização server-side; não introduzir router, estado global, framework UI ou dependência relevante sem spec e evidência. |
...
|---|---|
| Mapa de specs | As 35 specs ativas têm backlog proprietário: 30 concluídas, P8-02 parcialmente entregue, P9-05 bloqueada, P10-01/P10-02/P10-03/P10-04/P10-05/P10-06/P10-07 concluídas e P10-08 pendente. O índice corrige as referências P7/P8 a PDF; esse estado corresponde ao código, salvo as caixas históricas de P1/P7 e o DoD ainda aberto de P8-02. |
...
**Próxima passagem: P10-08.** Validar transversalmente os slices P10 concluídos, incluindo administração, sem reabrir owners funcionais. P9-05 continua aberto e bloqueado até resolver as decisões externas e o gate de backup físico.
