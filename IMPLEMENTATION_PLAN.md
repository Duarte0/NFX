...
| Estado geral | P0–P6, P7-01/P7-02/P7-03, P8-01/P8-03, P9-01/P9-02/P9-03/P9-04 e P10-01/P10-02/P10-03/P10-04/P10-05/P10-06 concluídos; os issues 0035, 0036, 0037, 0038 e 0039 verificaram o frontend na matriz sintética Chrome/Firefox/Edge; os follow-ups P0 de entrega da rota raiz React e provisionamento seguro do administrador foram concluídos e verificados nos issues 0032 e 0033; P8-02 tem slice inicial, integração Admin-only do status de backup e drill-downs de coleta, documentos, empresas, certificados e jobs concluídos nos issues 0018/0025–0030; fontes P5–P7, rendering e disco seguem pendentes. P9-05 permanece bloqueado externamente; P10-07..08 seguem. |
...
| 4 | **P10 Frontend UX & Visual System — in progress (P10-01..P10-06 concluídos)** | Modernizar a experiência operacional sem reescrita funcional: identidade institucional, shell desktop/notebook, componentes compartilhados e apresentação consistente dos fluxos já entregues. Specs P10-01..08 definem os contratos; cada slice só conclui com compatibilidade de contratos e validação dos estados críticos aplicáveis. | É independente de P9-05; P10-07..08 seguem após empresas, certificados, coletas e exportações. As matrizes Docker sintéticas de P10-02..P10-06 são reproduzíveis sem dados reais. Preserva `App → features → shared`, contratos HTTP, IDs/âncoras, URLs de drill-down e autorização server-side; não introduzir router, estado global, framework UI ou dependência relevante sem spec e evidência. |
...
|---|---|
| Mapa de specs | As 35 specs ativas têm backlog proprietário: 29 concluídas, P8-02 parcialmente entregue, P9-05 bloqueada, P10-01/P10-02/P10-03/P10-04/P10-05/P10-06 concluídas e P10-07..08 pendentes. O índice corrige as referências P7/P8 a PDF; esse estado corresponde ao código, salvo as caixas históricas de P1/P7 e o DoD ainda aberto de P8-02. |
...
**Próxima passagem: P10-07.** Detalhar o slice de administração sobre o dashboard, documentos, empresas, certificados, coletas, exportações, shell e fundação concluídos; P10-08 fará a validação transversal após esse slice. P9-05 continua aberto e bloqueado até resolver as decisões externas e o gate de backup físico.
