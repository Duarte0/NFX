...
P4-01 adicionou a identidade e persistência base de documentos/eventos em `documents`, com referências imutáveis a artefatos. Ainda não há pipeline/cursor P4-02, API/UI P4-04, exportações, retenção ou renderização. Simuladores são infraestrutura de teste; não implementam P4-02–P6.
