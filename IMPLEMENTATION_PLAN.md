...
| 4 | **P10 Frontend UX & Visual System — in progress (P10-01/P10-02/P10-03 concluídos)** | Modernizar a experiência operacional sem reescrita funcional: identidade institucional, shell desktop/notebook, componentes compartilhados e apresentação consistente dos fluxos já entregues. Specs P10-01..08 definem os contratos; cada slice só conclui com compatibilidade de contratos e validação dos estados críticos aplicáveis. | É independente de P9-05; P10-04..08 seguem depois do dashboard. As matrizes Docker sintéticas de P10-02/P10-03 são reproduzíveis sem dados reais. Preserva `App → features → shared`, contratos HTTP, IDs/âncoras, URLs de drill-down e autorização server-side; não introduzir router, estado global, framework UI ou dependência relevante sem spec e evidência. |
...
|---|---|
| Mapa de specs | As 35 specs ativas têm backlog proprietário: 27 concluídas, P8-02 parcialmente entregue, P9-05 bloqueada, P10-01/P10-02/P10-03/P10-04 concluídas e P10-05..08 pendentes. O índice corrige as referências P7/P8 a PDF; esse estado corresponde ao código, salvo as caixas históricas de P1/P7 e o DoD ainda aberto de P8-02. |
...
**Próxima passagem: P10-05..07.** Detalhar os slices de empresas, certificados, coletas, exportações e administração sobre o dashboard, documentos, shell e fundação concluídos; P10-08 fará a validação transversal após esses slices. P9-05 continua aberto e bloqueado até resolver as decisões externas e o gate de backup físico.
