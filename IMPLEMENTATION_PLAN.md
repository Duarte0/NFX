...
|---|---|
| Mapa de specs | As 35 specs ativas têm backlog proprietário: 26 concluídas, P8-02 parcialmente entregue, P9-05 bloqueada, P10-01/P10-02/P10-03 concluídas e P10-04..08 pendentes. O índice corrige as referências P7/P8 a PDF; esse estado corresponde ao código, salvo as caixas históricas de P1/P7 e o DoD ainda aberto de P8-02. |
...
- **P10 adotado:** vinho, cinza e branco são a direção visual de produto; P10-01 registrou os valores exatos, pares de contraste e primitives em sua spec. P10-02 acrescentou o shell desktop/notebook e a navegação por papel com hashes e destino de certificado único; P10-03 acrescentou a composição agrupada do dashboard e a retenção stale/error do payload owner-provided; as matrizes Docker sintéticas em Chrome/Firefox/Edge, com foco, teclado e larguras desktop, passaram. O trabalho preserva a arquitetura `App → features → shared`, sem router, estado global, framework UI ou backend adicional por conveniência visual.
...
**Próxima passagem: P10-04..07.** Detalhar os slices de domínio sobre o dashboard, shell e fundação concluídos; P10-08 fará a validação transversal após esses slices. P9-05 continua aberto e bloqueado até resolver as decisões externas e o gate de backup físico.
